...
CREATE TABLE `auth_token`  (
  ...
  `host` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '生成此次token的主机',
  `create_time` datetime(0) DEFAULT NULL COMMENT '本次token创建时间',
  `expire_time` datetime(0) NOT NULL COMMENT 'token失效时间',
  `mark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备用',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博文' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_quotation`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `blog_id` int(0) DEFAULT NULL COMMENT '博文id',
...
) ENGINE = InnoDB  CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博文引用' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '书' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '书签文件夹' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '语录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存放所有的文件信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `image_file`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `object_id` int(0) DEFAULT NULL COMMENT '对象的id',
  `file_id` int(0) DEFAULT NULL COMMENT '文件 (efile) id',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '各种对象关联的图片' ROW_FORMAT = Dynamic;
...
CREATE TABLE `munk_tag`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `tag_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标签名',
  `object_id` int(0) DEFAULT NULL COMMENT '对象id',
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所属对象的类型, 博文-Blog, 日志-DailyLog, 书架-Books, 游戏-Games',
  `valid` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '1' COMMENT '0-失效, 1-生效',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `role_auth`  (
  ...
  `permission` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '某一个权限',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表（不实现评论和留言，但是保留）' ROW_FORMAT = Dynamic;
